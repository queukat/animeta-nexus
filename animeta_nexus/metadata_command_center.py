...
ROOT = Path(os.getenv("ANIMETA_NEXUS_ROOT", Path.cwd())).resolve()
if not (ROOT / "docs").exists() and not (ROOT / "README.md").exists():
    ROOT = DEFAULT_ROOT
DOCS = ROOT / "docs"
DEMO = DOCS / "demo"
ASSETS = DOCS / "assets"
    ...
    <section class="hero shell">
      <div>
        ...
        <div class="hero-actions">
          ...
          <a class="button" href="https://github.com/queukat/animeta-nexus#run-the-demo">Run Demo</a>
          <a class="button" href="https://github.com/queukat/animeta-nexus/blob/main/docs/OPERATING_ROADMAP.md">Roadmap</a>
        </div>
      </div>
